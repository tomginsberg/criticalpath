      ...
      <div className="container relative">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 relative">
            ...
            <div className="absolute left-4 sm:left-4 top-0 bottom-0 w-0.5 bg-gradient-to-b from-gray-600 to-gray-200 hidden sm:block"></div>

            <div className="pl-10 sm:pl-16 relative">
              {/* Dot perfectly centered on the line */}
              <div className="absolute left-1 sm:left-1 top-2 w-6 h-6 rounded-full bg-gray-600 flex items-center justify-center shadow-md hidden sm:flex">
            ...
            <div className="pl-10 sm:pl-16 relative">
              ...
              <div className="bg-gray-200 p-6 border-l-4 border-gray-600">
