...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn(className)}>
      <p className="px-8 text-4xl md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 to-neutral-700 relative z-10 ">
        Let us Find your Critical Path
      </p>
      <div className="py-6"/>
      <p className="px-2 text-lg md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
      ...
      <svg
        ...
        className="absolute top-[55px] sm:top-[-60px] md:top-[-60px] lg:top-[-300px] w-screen left-1/2 -translate-x-1/2 z-0"
      >
        <motion.path
