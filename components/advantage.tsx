...
export default function Advantage() {
  return (
    <section id="advantage" className="py-16 md:py-24 bg-blue-500">
      <div className="container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-white">The Critical Path Advantage</h2>
          ...
          <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white">
              <span className="bg-blue-400 text-white text-xs font-medium px-2.5 py-1 rounded">Active Project</span>
              <p className="text-sm mt-2">
                Commercial retail space under construction - structural steel erection
              </p>
            </div>
          </div>
        </div>
