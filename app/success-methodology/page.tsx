      ...
      <div className="container">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-3xl">
            Our proven methodology ensures your project is delivered on time, on budget, and meets all your
            expectations.
          </p>
        </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-teal-600">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <p>PM creates a clear schedule that meets project requirements</p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-teal-600 flex-shrink-0 mt-1" />
                <p>
                  PM ensures good communication and coordination between professionals (Architect, Designer, Engineers)
                  through a defined meeting schedule
                </p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-teal-600 flex-shrink-0 mt-1" />
                <p>PM focuses daily on schedule dates and ensures all stay on track</p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-teal-600 flex-shrink-0 mt-1" />
                <p>PM is expert at managing architects, engineers and contractors to ensure delivery</p>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <p>PM ensures clearly defined project scope and objectives</p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-blue-600 flex-shrink-0 mt-1" />
                <p>PM sets up and manages communications and construction Meetings</p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-blue-600 flex-shrink-0 mt-1" />
                <p>
                  PM responsible for comprehensive communication, paperwork & reporting processes put in place to manage
                  the project
                </p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-blue-600 flex-shrink-0 mt-1" />
                <p>PM's only focus is the Project Management</p>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-600">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <p>PM ensures client needs are properly translated into construction drawings</p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-purple-600 flex-shrink-0 mt-1" />
                <p>PM manages unforeseen site conditions through better pre-construction investigations</p>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="h-5 w-5 text-purple-600 flex-shrink-0 mt-1" />
                <p>PM makes sure the budget represents "Total" Project costs including all 'soft costs'</p>
              </li>
            </ul>
          </div>
        ...
        <div className="hidden md:block relative">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-teal-600">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex gap-3">
                  <CheckCircle className="h-5 w-5 text-teal-600 flex-shrink-0 mt-1" />
                  <p>
                    PM ensures good communication and coordination between professionals (Architect, Designer,
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex gap-3">
                  <CheckCircle className="h-5 w-5 text-blue-600 flex-shrink-0 mt-1" />
                  <p>
                    PM responsible for comprehensive communication, paperwork & reporting processes put in place to
                    manage the project
                  </p>
                </li>
                <li className="flex gap-3">
          ...
          {/* Flow lines */}
          <div className="absolute left-1/6 top-[calc(100%-4rem)] w-2/3 h-16 border-b-2 border-l-2 border-r-2 border-gray-300 rounded-b-xl"></div>
          <div className="absolute left-1/2 top-[calc(100%-4rem)] w-0 h-16 border-l-2 border-gray-300"></div>

          {/* Result box */}
          <div className="bg-teal-50 p-8 rounded-lg border border-teal-200 text-center max-w-2xl mx-auto relative">
            ...
            <div className="flex items-center justify-center gap-6">
              <Image
                src="/images/project-success-diagram.png"
                alt="Critical Path Projects Logo"
                width={150}
                height={150}
